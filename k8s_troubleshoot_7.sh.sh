...
svcname=svc7
podname=pod7
depname=HCL-deploy-7
cmname=nginx-index-cm7
volname=nginx-conf7
subpath=index7.html
indexfile=/data/index7.html
...
mv /etc/kubernetes/manifests/kube-scheduler.yaml /$namespace
...
if [ $? -eq 0 ];then
 ...
 echo "\nAll Definition files and backups are saved in /$namespace directory feel free to review"
